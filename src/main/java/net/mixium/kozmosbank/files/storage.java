...
public class storage  {
    ...
    public storage(KozmosBank plugin, String path, String storage) {
        net.mixium.kozmosbank.files.storage.main = plugin;
        net.mixium.kozmosbank.files.storage.path = path;
        file = null;
        config = null;
        folderpath = storage;
    }
    ...
    public static void create() {
        ...
        if (!file.exists()) {
            loggman.send("File storage/datas.yml created...");
